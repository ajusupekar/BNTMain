...
public class MasonsAppStepDef 
{
	...
	@When("^android user select the grand lodge or lodge \"([^\"]*)\"$")
	public void android_user_select_the_grand_lodge_or_lodge(String GLorLodge) throws Throwable 
	{
		GLorLodge = Constants.ANDROIDTestData.getProperty("IMasonAt");
		...
		try
		{
			...
			for(int i=0 ; i<sizemasonAtList ; i++)
			{
				...
				if(masonAtTxt.equalsIgnoreCase(GLorLodge.trim()))
				{
					...
					LogCapture.info("Android user selected specify lodge or grand lodge at..."+GLorLodge);
					break;
				}
			}
		}
	...
	public void android_user_entering_the_Pin(String optionValue , String data) throws Throwable 
	{
		if(optionValue.equalsIgnoreCase("entering"))
		{
			...
			LogCapture.info("Android user entered Pin successfully for individual mason..."+data);
		}
		else if(optionValue.equalsIgnoreCase("re-entering"))
		{
			...
			LogCapture.info("Android user re-entered Pin successfully for individual mason..."+data);
		}
	}		
	...
	@Then("^android user land on (Individual mason Profile|Pin created for individual mason|Pin changed for individual mason|Pin Removed for individual mason) screen$")
	public void android_user_is_on_Individual_mason_Profile_screen(String optionValue) throws Throwable 
	{
		if(optionValue.equalsIgnoreCase("Individual mason Profile"))
		{
			...
			LogCapture.info("Android user is on Individual mason profile screen...");
		}
		else if(optionValue.equalsIgnoreCase("Pin created for individual mason"))
		{
	...
	public void android_user_land_on_Add_ACH_Account_screen_in_IM_app(String optionValue) throws Throwable 
	{
		if(optionValue.equalsIgnoreCase("Add ACH Accounts"))
		{
			...
			LogCapture.info("Android user is on Ach Accounts screen in IM App...");
		}
		else if(optionValue.equalsIgnoreCase("Ach account created"))
		{
			...
			LogCapture.info("Android user is on Ach Account Created screen in IM App...");
		}
	}
	...
	public void android_user_select_Ach_Account_card_base_on(String data) throws Throwable 
	{
		...
		for(int i=0 ; i<achCardSize ; i++)
		{
			...
			if(actCardLastDigits.equalsIgnoreCase(vExpLastDigits))
			{
				...
				LogCapture.info("Android user selected the ACH Account...");
				break;
			}
			else 
			{
				LogCapture.info("Android user is not able to select the ACH Account...");
			}
		} 
	}
	...
	public void android_user_verify_Individual_Mason_account_balance_before_adding_money(String optionValue) throws Throwable 
	{
		...
		else if(optionValue.equalsIgnoreCase("after"))
		{
			...
			System.out.println("Individual Mason Account Balance Is : "+Constants.DataMap);
		}
	}
	...
	public void android_user_click_on_See_All_option_to_see_all_Transactions() throws Throwable 
	{
		...
		LogCapture.info("Android user clicked on See All option to see all the Transactions...");
	}
